...
class ComputersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'id_code' => ['type' => 'string', 'length' => 2, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'computers_ibfk_1' => ['type' => 'foreign', 'columns' => ['store_id'], 'references' => ['stores', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'active' => 1,
            'deleted' => 1,
            'created' => '2016-11-18 13:22:22',
            'modified' => '2016-11-18 13:22:22'
        ],
    ];
}
