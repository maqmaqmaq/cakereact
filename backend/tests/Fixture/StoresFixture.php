...
class StoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'account_key' => ['type' => 'index', 'columns' => ['account_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'stores_ibfk_1' => ['type' => 'foreign', 'columns' => ['account_id'], 'references' => ['accounts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'deleted' => 1,
            'created' => '2016-11-18 13:22:16',
            'modified' => '2016-11-18 13:22:16'
        ],
    ];
}
